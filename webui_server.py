    ...
    <div class="body">
      <div class="card">
        ...
        <div class="small">
          ...
          2. 左侧像最终用户一样发消息。<br/>
          3. 左下看 Job、Events、Artifacts、report.md 和白盒诊断。<br/>
          4. 右侧是工程开发终端，修复任务会发给 open_claude。<br/>
          5. 改完代码后，点左侧“重启当前 Agent”验证是否生效。
        </div>
      </div>
